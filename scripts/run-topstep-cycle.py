...
CYCLE_OPERATOR_INSTRUCTION = (
    ...
    "a reference robustness margin validated by the contract, not a universal subjective gate; also weigh "
    "range width, evidence quality, geometry, and execution uncertainty together. "
