...
class DirectCycleTests(unittest.TestCase):
    ...
    def test_build_prompt_template_uses_neutral_placeholders(self):
        ...
        self.assertIn("INSTRUMENT_COMPARISON_V1", template["decision_audit"]["decisive_evidence"])
        self.assertIn("FIVE_TO_TEN_BAR_FORECAST", template["decision_audit"]["decisive_evidence"])
